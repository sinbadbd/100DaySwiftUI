...
var recipes = [
    ...
    Recipe(image: "r2", title: "Italian Baked Dish3", detail: "Italian based spicy and green beans baked together with cheeze", rating: "3.0", type: "medium",color: Color("yellow"))
]
